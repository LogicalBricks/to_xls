...
To change the format of the cells, headers and columns the code should be like this:
      ...
      User.all.to_xls :cell_format => {:color => :blue}, 
        :header_format => {:weight => :bold, :color => :red}, 
        :column_format => {[:created_at, :updated_at] => {:number_format => 'DD/MM/YYYY'}}, 
        :column_width => {[:created_at, :updated_at] => 12}

Check the {wiki}[https://github.com/LogicalBricks/to_xls/wiki/Additional-options] for a more detailed example using column_format an column_width
